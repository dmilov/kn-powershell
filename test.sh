...
curl -d@structured-payload -H "Content-Type: application/json" -H 'ce-specversion: "1.0"' -H 'ce-id: "id-123"' -H 'ce-source: "source-123"' -H 'ce-type: "type-123"' -X POST localhost:8080
